                ...
                <div class="card">
                    <div class="card-header border-bottom border-dashed d-flex flex-wrap align-items-center gap-2">
                        <div class="flex-grow-1">
                            <h4 class="header-title">Danh sách thực vật</h4>
                        </div>
                        <div class="d-flex flex-wrap flex-lg-nowrap gap-2">
                            <a href="{{ route('thuc-vat.create') }}" class="btn btn-sm btn-primary rounded-pill">
                    ...
                    <div class="card-body">
                        <table class="table table-hover dt-responsive nowrap w-100 fixed-header-datatable">
                            ...
                            <tbody id="body_data">
                                @forelse($thucVats as $index => $item)
                                    <tr>
                                        <td>{{ $index + 1 }}</td>
                                        <td>
                                        ...
                                        <td>
                                            <div class="hstack gap-2 fs-15 justify-content-center">
                                                <a href="{{ route('thuc-vat.show', $item->id) }}"
                                                ...
                                                <a href="{{ route('thuc-vat.edit', $item->id) }}"
                                                ...
                                                <a href="#" data-toggle="tooltip" data-bs-custom-class="tooltip-danger"
                                                    ...
                                                    data-bs-href="{{ route('thuc-vat.destroy', $item->id) }}"
