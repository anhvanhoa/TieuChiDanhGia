                ...
                <div class="card">
                    <div class="card-header border-bottom border-dashed d-flex flex-wrap align-items-center gap-2">
                        <div class="flex-grow-1">
                            <h4 class="header-title">Cập nhật thực vật</h4>
                        </div>
                    ...
                    <div class="card-body">
                        <form action="{{ route('thuc-vat.update', $thucVat->id) }}" method="POST">
                            @csrf
                            @method('PUT')
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        ...
                                        <select class="form-control" id="bac_chi_id" name="bac_chi_id" required>
                                            ...
                                            @foreach($bacChis as $chi)
                                                <option value="{{ $chi->id }}"
                                                    {{ (old('bac_chi_id', $thucVat->bac_chi_id) == $chi->id) ? 'selected' : '' }}>
                                ...
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control" id="ten_khoa_hoc" name="ten_khoa_hoc"
                                            value="{{ old('ten_khoa_hoc', $thucVat->ten_khoa_hoc) }}" placeholder="Nhập tên khoa học"
                                            required>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control" id="ten_tieng_viet" name="ten_tieng_viet"
                                            value="{{ old('ten_tieng_viet', $thucVat->ten_tieng_viet) }}" placeholder="Nhập tên tiếng Việt"
                                            required>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control" id="ten_tac_gia" name="ten_tac_gia"
                                            value="{{ old('ten_tac_gia', $thucVat->ten_tac_gia) }}" placeholder="Nhập tên tác giả">
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        ...
                                        <textarea class="form-control" id="than_canh" name="than_canh" rows="3"
                                            placeholder="Mô tả thân cành">{{ old('than_canh', $thucVat->than_canh) }}</textarea>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        ...
                                        <textarea class="form-control" id="la" name="la" rows="3"
                                            placeholder="Mô tả lá">{{ old('la', $thucVat->la) }}</textarea>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        ...
                                        <textarea class="form-control" id="phan_bo_viet_nam" name="phan_bo_viet_nam" rows="2"
                                            placeholder="Mô tả phân bố tại Việt Nam">{{ old('phan_bo_viet_nam', $thucVat->phan_bo_viet_nam) }}</textarea>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        ...
                                        <textarea class="form-control" id="phan_bo_the_gioi" name="phan_bo_the_gioi" rows="2"
                                            placeholder="Mô tả phân bố trên thế giới">{{ old('phan_bo_the_gioi', $thucVat->phan_bo_the_gioi) }}</textarea>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        ...
                                        <textarea class="form-control" id="hoa_qua" name="hoa_qua" rows="3"
                                            placeholder="Mô tả hoa quả">{{ old('hoa_qua', $thucVat->hoa_qua) }}</textarea>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        ...
                                        <textarea class="form-control" id="sinh_thai" name="sinh_thai" rows="3"
                                            placeholder="Mô tả sinh thái">{{ old('sinh_thai', $thucVat->sinh_thai) }}</textarea>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="col-md-4">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control" id="dac_huu" name="dac_huu"
                                            value="{{ old('dac_huu', $thucVat->dac_huu) }}" placeholder="Nhập đặc hữu">
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control" id="sach_do" name="sach_do"
                                            value="{{ old('sach_do', $thucVat->sach_do) }}" placeholder="Nhập sách đỏ">
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control" id="iucn" name="iucn"
                                            value="{{ old('iucn', $thucVat->iucn) }}" placeholder="Nhập IUCN">
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control" id="nd_84" name="nd_84"
                                            value="{{ old('nd_84', $thucVat->nd_84) }}" placeholder="Nhập NĐ 84">
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        ...
                                        <textarea class="form-control" id="gia_tri" name="gia_tri" rows="2"
                                            placeholder="Mô tả giá trị">{{ old('gia_tri', $thucVat->gia_tri) }}</textarea>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="col-12">
                                    <div class="mb-3">
                                        ...
                                        <textarea class="form-control" id="nguon" name="nguon" rows="2"
                                            placeholder="Nhập nguồn tham khảo">{{ old('nguon', $thucVat->nguon) }}</textarea>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="col-12">
                                    <div class="image-management-section">
                                        <div class="image-management-header">
                                            ...
                                            <p class="text-muted">Quản lý hình ảnh của thực vật</p>
                                        </div>
                                        <div class="image-management-body">
                                            <!-- Ảnh hiện có -->
                                            @if($images && count($images) > 0)
                                            <div class="existing-images-section">
                                                <h6 class="existing-images-title">Ảnh hiện có ({{ count($images) }})</h6>
                                            ...
                                            <div class="new-images-section">
                                                ...
                                                <div id="imagesPreview" class="existing-images-grid mt-3">
                                                    <!-- Ảnh mới đã chọn sẽ hiển thị ở đây -->
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                ...
                $.ajax({
                    ...
                    success: function(response) {
                        if (response.success) {
                            ...
                            if ($('#existingImages .col-md-3').length === 0) {
                ...
                $.ajax({
                    ...
                    error: function(xhr) {
                        ...
                        if (response && response.errors) {
                            ...
                            showToast('Lỗi', response?.message || 'Có lỗi xảy ra khi cập nhật thực vật', 'error');
                        }
                    }
                });
            }
