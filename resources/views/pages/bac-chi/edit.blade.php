                ...
                <div class="card">
                    <div class="card-header border-bottom border-dashed d-flex flex-wrap align-items-center gap-2">
                        <div class="flex-grow-1">
                            <h4 class="header-title">Chỉnh sửa chi</h4>
                        </div>
                    ...
                    <div class="card-body">
                        <form action="{{ route('bac-chi.update', $bacChi->id) }}" method="POST">
                            @csrf
                            @method('PUT')
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        ...
                                        <select class="form-control" id="bac_ho_id" name="bac_ho_id" required>
                                            ...
                                            @foreach($bacHos as $ho)
                                                <option value="{{ $ho->id }}"
                                                    {{ old('bac_ho_id', $bacChi->bac_ho_id) == $ho->id ? 'selected' : '' }}>
                                ...
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control" id="ten_khoa_hoc" name="ten_khoa_hoc"
                                            value="{{ old('ten_khoa_hoc', $bacChi->ten_khoa_hoc) }}"
                                ...
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control" id="ten_tieng_viet" name="ten_tieng_viet"
                                            value="{{ old('ten_tieng_viet', $bacChi->ten_tieng_viet) }}"
