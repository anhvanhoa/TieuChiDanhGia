                ...
                <div class="card">
                    <div class="card-header border-bottom border-dashed d-flex flex-wrap align-items-center gap-2">
                        <div class="flex-grow-1">
                            <h4 class="header-title">Chỉnh sửa loại vườn quốc gia</h4>
                        </div>
                    ...
                    <div class="card-body">
                        <form action="{{ route('loai-vuon-quoc-gia.update', $loaiVuonQuocGia->id) }}" method="POST">
                            @csrf
                            @method('PUT')
                            <div class="row">
                                <div class="col-md-8">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control"
                                            ...
                                            value="{{ old('ten_loai', $loaiVuonQuocGia->ten_loai) }}"
                                            placeholder="Nhập tên loại vườn quốc gia" required>
                                        <div class="form-text">
