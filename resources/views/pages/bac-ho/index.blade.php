                ...
                <div class="card">
                    <div class="card-header border-bottom border-dashed d-flex flex-wrap align-items-center gap-2">
                        <div class="flex-grow-1">
                            <h4 class="header-title">Danh sách họ</h4>
                        </div>
                        <div class="d-flex flex-wrap flex-lg-nowrap gap-2">
                            <a href="{{ route('bac-ho.create') }}" class="btn btn-sm btn-primary rounded-pill">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <span class="badge bg-success-subtle text-success">
                                                {{ $item->bacBo->ten_tieng_viet ?? 'N/A' }}
                                            </span>
                                        </td>
                                        <td>
                                            <span class="badge bg-warning-subtle text-warning">
                                                {{ $item->bacBo->bacLop->ten_tieng_viet ?? 'N/A' }}
                                            </span>
                                        </td>
                                        <td>
                                            <span class="badge bg-primary-subtle text-primary">
                                                {{ $item->bacBo->bacLop->bacNganh->ten_tieng_viet ?? 'N/A' }}
                                            </span>
                                        </td>
                                        <td>{{ $item->created_at ? $item->created_at->format('d-m-Y H:i:s') : 'N/A' }}</td>
                                        <td>
                                            <div class="hstack gap-2 fs-15 justify-content-center">
                                                <a href="{{ route('bac-ho.show', $item->id) }}"
                                                ...
                                                <a href="{{ route('bac-ho.edit', $item->id) }}"
                                                ...
                                                <a href="#" data-toggle="tooltip" data-bs-custom-class="tooltip-danger"
                                                    ...
                                                    data-bs-href="{{ route('bac-ho.destroy', $item->id) }}"
