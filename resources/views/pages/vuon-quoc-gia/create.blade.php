                ...
                <div class="card">
                    <div class="card-header border-bottom border-dashed d-flex flex-wrap align-items-center gap-2">
                        <div class="flex-grow-1">
                            <h4 class="header-title">Thêm vườn quốc gia mới</h4>
                        </div>
                    ...
                    <div class="card-body">
                        <form action="{{ route('vuon-quoc-gia.store') }}" method="POST">
                            @csrf
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control" id="ten_vuon" name="ten_vuon"
                                            value="{{ old('ten_vuon') }}" placeholder="Nhập tên vườn quốc gia"
                                            required>
                                        <div class="form-text">
                                ...
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        ...
                                        <select class="form-control" id="loai_vuon_quoc_gia_id" name="loai_vuon_quoc_gia_id" required>
                                            <option value="">-- Chọn loại vườn quốc gia --</option>
                                            @foreach($loaiVuonQuocGias as $loai)
                                                <option value="{{ $loai->id }}" {{ old('loai_vuon_quoc_gia_id') == $loai->id ? 'selected' : '' }}>
                                                    {{ $loai->ten_loai }}
                                                </option>
                                            @endforeach
                                        </select>
                                ...
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        ...
                                        <input type="date" class="form-control" id="ngay_thanh_lap" name="ngay_thanh_lap"
                                            value="{{ old('ngay_thanh_lap') }}" required>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control" id="dia_chi" name="dia_chi"
                                            value="{{ old('dia_chi') }}" placeholder="Nhập địa chỉ vườn quốc gia"
                                            required>
                                    </div>
                                </div>
                            </div>
...
@section('script')
    <script>
        $(document).ready(function () {
            $('#ten_vuon').focus();
            initSumoSelect($('#loai_vuon_quoc_gia_id'));
        });
    </script>
@endsection
