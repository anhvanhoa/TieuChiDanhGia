                ...
                <div class="card">
                    <div class="card-header border-bottom border-dashed d-flex flex-wrap align-items-center gap-2">
                        <div class="flex-grow-1">
                            <h4 class="header-title">Danh sách ngành</h4>
                        </div>
                        <div class="d-flex flex-wrap flex-lg-nowrap gap-2">
                            <a href="{{ route('bac-nganh.create') }}" class="btn btn-sm btn-primary rounded-pill">
                    ...
                    <div class="card-body">
                        <table class="table table-hover dt-responsive nowrap w-100 fixed-header-datatable">
                            ...
                            <tbody id="body_data">
                                @forelse($bacNganhs as $index => $item)
                                    <tr>
                                        <td>{{ $index + 1 }}</td>
                                        <td>
                                        ...
                                        <td>
                                            <div class="hstack gap-2 fs-15 justify-content-center">
                                                ...
                                                <a href="{{ route('bac-nganh.edit', $item->id) }}"
                                                ...
                                                <a href="#" data-toggle="tooltip" data-bs-custom-class="tooltip-danger"
                                                    ...
                                                    data-bs-href="{{ route('bac-nganh.destroy', $item->id) }}"
