                ...
                <div class="card">
                    <div class="card-header border-bottom border-dashed d-flex flex-wrap align-items-center gap-2">
                        <div class="flex-grow-1">
                            <h4 class="header-title">Chỉnh sửa bộ</h4>
                        </div>
                    ...
                    <div class="card-body">
                        <form action="{{ route('bac-bo.update', $bacBo->id) }}" method="POST">
                            @csrf
                            @method('PUT')
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        ...
                                        <select class="form-control" id="bac_lop_id" name="bac_lop_id" required>
                                            ...
                                            @foreach($bacLops as $lop)
                                                <option value="{{ $lop->id }}"
                                                    {{ old('bac_lop_id', $bacBo->bac_lop_id) == $lop->id ? 'selected' : '' }}>
                                ...
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control" id="ten_khoa_hoc" name="ten_khoa_hoc"
                                            value="{{ old('ten_khoa_hoc', $bacBo->ten_khoa_hoc) }}"
                                ...
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control" id="ten_tieng_viet" name="ten_tieng_viet"
                                            value="{{ old('ten_tieng_viet', $bacBo->ten_tieng_viet) }}"
